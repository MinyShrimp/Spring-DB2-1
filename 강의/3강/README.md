...
* [공식 Docs](https://mybatis.org/mybatis-3/ko/java-api.html)
...
* `<property>`: 프로퍼티 값을 전달할 수 있고, 해당 값은 내부에서 사용할 수 있다.
...
> [공식 Docs](https://mybatis.org/mybatis-3/ko/sqlmap-xml.html#Result_Maps)
