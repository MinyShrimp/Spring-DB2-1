...
INSERT INTO item (item_name, price, quantity) VALUES(?, ?, ?) [42104-214]
```
...
[공식 Docs](https://docs.spring.io/spring-boot/docs/current/reference/html/howto.html#howto.data-initialization.using-basic-sql-scripts)
...
DriverManagerDataSource : Creating new JDBC DriverManager Connection to [jdbc:h2:mem:db;DB_CLOSE_DELAY=-1]
ScriptUtils             : Executing SQL script from file [/Users/gimhoemin/Desktop/project/java/spring/study/spring-db-2/out/test/resources/schema.sql]
ScriptUtils             : 0 returned as update count for SQL: drop table if exists item CASCADE
ScriptUtils             : 0 returned as update count for SQL: create table item ( id bigint generated by default as identity, item_name varchar(10), price integer, quantity integer, primary key (id) )
ScriptUtils             : Executed SQL script from file [/Users/gimhoemin/Desktop/project/java/spring/study/spring-db-2/out/test/resources/schema.sql] in 11 ms.
ItemRepositoryTest      : Started ItemRepositoryTest in 0.851 seconds (process running for 1.581)
JdbcTransactionManager  : Creating new transaction with name [hello.springdb2.domain.ItemRepositoryTest.updateItem]: PROPAGATION_REQUIRED,ISOLATION_DEFAULT
```
...
```
# SQL 초기화
o.s.jdbc.datasource.init.ScriptUtils     : Executing SQL script from file [/Users/gimhoemin/Desktop/project/java/spring/study/spring-db-2/out/test/resources/schema.sql]
...
o.s.jdbc.datasource.init.ScriptUtils     : Executed SQL script from file [/Users/gimhoemin/Desktop/project/java/spring/study/spring-db-2/out/test/resources/schema.sql] in 6 ms.

# 테스트 시작
h.springdb2.domain.ItemRepositoryTest    : Started ItemRepositoryTest in 0.953 seconds (process running for 1.738)

# 트랜잭션 시작
o.s.jdbc.support.JdbcTransactionManager  : Creating new transaction with name [hello.springdb2.domain.ItemRepositoryTest.updateItem]: PROPAGATION_REQUIRED,ISOLATION_DEFAULT

# 커넥션 획득
o.s.jdbc.support.JdbcTransactionManager  : Acquired Connection [HikariProxyConnection@150208546 wrapping conn0: url=jdbc:h2:mem:3f3ac64c-8cfc-403d-a66e-6f82a0f354d9 user=SA] for JDBC transaction
o.s.jdbc.support.JdbcTransactionManager  : Switching JDBC Connection [HikariProxyConnection@150208546 wrapping conn0: url=jdbc:h2:mem:3f3ac64c-8cfc-403d-a66e-6f82a0f354d9 user=SA] to manual commit

# 쿼리문 전송
o.s.jdbc.core.simple.SimpleJdbcInsert    : JdbcInsert not compiled before execution - invoking compile
o.s.j.c.m.TableMetaDataProviderFactory   : Using GenericTableMetaDataProvider
o.s.j.c.metadata.TableMetaDataProvider   : GetGeneratedKeys is supported
o.s.j.c.metadata.TableMetaDataProvider   : GeneratedKeysColumnNameArray is supported for H2
o.s.j.c.metadata.TableMetaDataProvider   : Retrieving meta-data for 3F3AC64C-8CFC-403D-A66E-6F82A0F354D9/PUBLIC/ITEM
```

### 참고

[공식 Docs](https://docs.spring.io/spring-boot/docs/current/reference/html/data.html#data.sql.datasource.embedded)
